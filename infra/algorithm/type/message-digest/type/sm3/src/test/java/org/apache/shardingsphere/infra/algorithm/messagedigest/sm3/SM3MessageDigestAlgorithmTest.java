...
class SM3MessageDigestAlgorithmTest {
    ...
    @BeforeEach
    void setUp() {
        digestAlgorithm = TypedSPILoader.getService(MessageDigestAlgorithm.class, "SM3");
    }
    
    @Test
    void assertDigest() {
        assertThat(digestAlgorithm.digest("test"), is("VeEukWUNL+xW7HTh0+Tdv84u86ZYkMKhns+IowfnaiM="));
    }
    ...
    void assertDigestWhenConfigSalt() {
        ...
        assertThat(digestAlgorithm.digest("test"), is("C7uPBHT4icO2d9TQUP5PTMwCi8JoY44hig3vUH5vu84="));
    }
}
